...
class TestCnReposModule < Minitest::Test
  ...
  describe "ReposModule" do
    ...
    it "can create snapshot from external command" do
      ...
      @my_repo.clear()
      @my_repo.make_snapshot().wont_be_nil   # takeSnapshot will return success
    ...
    it "can restore snapshot from external command" do
      ...
      @my_repo.clear()
      @my_repo.make_snapshot().wont_be_nil
      repo1 = my_repo.current
      # clear/change the workspace
      @my_repo.restore_snapshot(repo1).wont_be_nil  # returned success
      @my_repo.diff_snapshots(repo1).must_be_nil             # restored correctly
    end
